...
*/
console.log(createMenuItem("hotdog", 1, "lunch"));
console.log(createMenuItem("cheeseburger", 2, "lunch"));
console.log(createMenuItem("soda", 1, "Drinks"));
...
*/
reviews.push({name: "Andrew", rating: 5, feedback: "This is some feedback."});
console.log(reviews);
